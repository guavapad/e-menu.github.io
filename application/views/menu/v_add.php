    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="5" placeholder="desripsi menu" value="<?= set_value('deskripsi') ?>"></textarea>
            </div>
            <!-- text input -->
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/no-foto.png') ?>" id="gambar_load">
                    </div>
                </div>
            </div>
            <!-- text input -->
